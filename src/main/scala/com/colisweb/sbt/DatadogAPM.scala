...
object DatadogAPM extends AutoPlugin {
  ...
  object TraceAgentUrl {
    ...
    final val defaultHttpUrl       = TraceAgentHttpUrl("localhost", "8126")
    final val defaultUnixSocketUrl = TraceAgentUnixSocketUrl("/var/run/datadog/apm.socket")
  }
